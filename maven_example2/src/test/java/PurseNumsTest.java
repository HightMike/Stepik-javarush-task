...
//
//        ByteArrayInputStream inputStream = new ByteArrayInputStream(input.getBytes(ParseNums.CHARSET));
...
//
//        // execute code
//        ParseNums.parseNums(inputStream, customStream, ParseNums.CHARSET);
//
